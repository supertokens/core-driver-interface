# PLEASE IGNORE THIS FILE. See https://app.swaggerhub.com/apis/supertokens/CDI/2.8.0 instead.

Related issue: https://github.com/supertokens/core-driver-interface/issues/8
...
### `/recipe/session/data` GET - @deprecated
Get session data
```
Request header:
- rid?: string
...
### `/recipe/jwt/data` GET - @deprecated
...
### `/recipe/users/count` GET - @deprecated
Get number of users
